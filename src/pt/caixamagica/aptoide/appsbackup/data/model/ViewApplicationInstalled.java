...
package pt.caixamagica.aptoide.appsbackup.data.model;
 ...
 *
 */
public class ViewApplicationInstalled {
	 ...
	 * 
	 */
	public ViewApplicationInstalled(String packageName, int versionCode, boolean isTypeInstalled) {
		if(isTypeInstalled){
	...
	public void setSize(long size){
		values.put(Constants.KEY_APP_INSTALLED_SIZE, size);
	}
	...
	public boolean equals(Object object) {
		if(object instanceof ViewApplicationInstalled){
			ViewApplicationInstalled app = (ViewApplicationInstalled) object;
