...
public class ViewDisplayAppVersionInfo implements Parcelable, Serializable{
	...
	// Parcelable stuff //
		...
		public void readFromParcel(Parcel in) {
			...
			if(statsAvailable){
				stats = in.readParcelable(pt.caixamagica.aptoide.appsbackup.data.display.ViewDisplayAppVersionStats.class.getClassLoader());
			}
			
			extrasAvailable = (Boolean) in.readValue(null);
			if(extrasAvailable){
				extras = in.readParcelable(pt.caixamagica.aptoide.appsbackup.data.display.ViewDisplayAppVersionExtras.class.getClassLoader());
			}
			
			commentsAvailable = (Boolean) in.readValue(null);
			if(commentsAvailable){
				comments = in.readParcelable(pt.caixamagica.aptoide.appsbackup.data.display.ViewDisplayListComments.class.getClassLoader());
			}
