...
import pt.caixamagica.aptoide.appsbackup.debug.EnumLogLevels;
...
//	public static final int DISPLAY_LISTS_PAGE_SIZE_MULTIPLIER = (DISPLAY_LISTS_PAGE_INCREASE_OFFSET_TRIGGER_PROPORTION_LEVEL+DISPLAY_LISTS_PAGE_DECREASE_OFFSET_TRIGGER_PROPORTION_LEVEL);
	...
	public static final String URI_FORMAT_LOGIN_WS = "http://www.bazaarandroid.com/webservices/checkUserCredentials/%1$s/%2$s/repo/%3$s/xml";		//TODO adapt to multiple servers
...
//			+ "PRIMARY KEY("+ KEY_LOGIN_REPO_HASHID +") );";
	...
	public static final String CREATE_TABLE_APPLICATION = "CREATE TABLE IF NOT EXISTS " + TABLE_APPLICATION + " ("
			...
			/** min_gles defaults to 1.0 encoded NOT acording to integer representation rules of gles float version id 
			 * found in: http://developer.android.com/guide/topics/manifest/uses-feature-element.html#glEsVersion  **/
