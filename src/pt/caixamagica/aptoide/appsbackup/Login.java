...
/**
 * Login, handles Aptoide's login interface (by activity)
 * 
 * @author dsilveira
 *
 */
...
//		this.invoqueType = ;	//TODO receive as Intent extra integer encoded
	...
	private void handleLogin(){
		//TODO convert from dialog_login to form_login
...
// 					new LoginTask(getContext(), loginProgress, serverLogin).execute();
// 					
// 				}
// 			}
// 		});
...
// 					new CreateAccountTask(getContext(), createAccountProgress, serverLogin).execute();
// 				}
// 			}
// 		});
// 		
