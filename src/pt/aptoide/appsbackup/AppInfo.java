...
import pt.aptoide.appsbackup.data.display.ViewDisplayComment;
import pt.aptoide.appsbackup.data.util.Constants;
import pt.aptoide.appsbackup.data.webservices.EnumServerStatus;
import pt.aptoide.appsbackup.ifaceutil.ImageAdapter;
import pt.aptoide.appsbackup.ifaceutil.StaticCommentsListAdapter;
			...
			public void onClick(View v) {
				...
				if(selectedVersion.getRepoUri() != null){
					...
					if(token == null){
						...
						DialogLogin loginLikes = new DialogLogin(AppInfo.this, serviceDataCaller, DialogLogin.InvoqueType.NO_CREDENTIALS_SET);
		...
		commentOnApp.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(selectedVersion.getRepoUri() != null){
					...
					if(token == null){
						Log.d("Aptoide-AppInfo", "No login set");
						DialogLogin loginComments = new DialogLogin(AppInfo.this, serviceDataCaller, DialogLogin.InvoqueType.NO_CREDENTIALS_SET);
...
//		commentsAdapter = new StaticCommentsListAdapter(this, comments, serviceDataCaller);
		...
		repoUriTextView.setText(getString(R.string.store)+": ");
