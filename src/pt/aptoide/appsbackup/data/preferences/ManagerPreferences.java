...
package pt.aptoide.appsbackup.data.preferences;

import java.util.UUID;

import pt.aptoide.appsbackup.EnumAppsSorting;
import pt.aptoide.appsbackup.data.AptoideServiceData;
import pt.aptoide.appsbackup.data.EnumConnectionLevels;
...
import pt.aptoide.appsbackup.data.webservices.EnumIconDownloadsPermission;
...
public class ManagerPreferences implements InterfaceAptoideLog{
	...
	private void createLauncherShortcut(Context context){
		...
		shortcutIntent.setClassName(context, "pt.aptoide.appsbackup.Aptoide");
		shortcutIntent.putExtra("pt.aptoide.appsbackup", context.getString(R.string.description));
