...
import pt.aptoide.appsbackup.Aptoide;
import pt.aptoide.appsbackup.BazaarLogin;
import pt.aptoide.appsbackup.EnumAppsSorting;
import pt.aptoide.appsbackup.ManageRepos;
import pt.aptoide.appsbackup.SelfUpdate;
import pt.aptoide.appsbackup.Splash;
import pt.aptoide.appsbackup.Upload;
import pt.aptoide.appsbackup.data.cache.ManagerCache;
import pt.aptoide.appsbackup.data.cache.ViewCache;
import pt.aptoide.appsbackup.data.database.ManagerDatabase;
...
import pt.aptoide.appsbackup.data.model.ViewApplicationInstalled;
import pt.aptoide.appsbackup.data.model.ViewIconInfo;
import pt.aptoide.appsbackup.data.model.ViewListIds;
import pt.aptoide.appsbackup.data.model.ViewLogin;
import pt.aptoide.appsbackup.data.model.ViewRepository;
import pt.aptoide.appsbackup.data.notifications.ManagerNotifications;
import pt.aptoide.appsbackup.data.preferences.EnumAgeRating;
import pt.aptoide.appsbackup.data.preferences.ManagerPreferences;
import pt.aptoide.appsbackup.data.preferences.ViewSettings;
import pt.aptoide.appsbackup.data.system.ManagerSystemSync;
...
import pt.aptoide.appsbackup.data.webservices.EnumDownloadType;
import pt.aptoide.appsbackup.data.webservices.EnumServerLoginCreateStatus;
import pt.aptoide.appsbackup.data.webservices.EnumServerLoginStatus;
import pt.aptoide.appsbackup.data.webservices.EnumServerStatus;
import pt.aptoide.appsbackup.data.webservices.EnumServerUploadApkStatus;
import pt.aptoide.appsbackup.data.webservices.ManagerDownloads;
import pt.aptoide.appsbackup.data.webservices.ManagerUploads;
import pt.aptoide.appsbackup.data.webservices.ViewApk;
import pt.aptoide.appsbackup.data.webservices.ViewDownload;
import pt.aptoide.appsbackup.data.webservices.ViewDownloadInfo;
import pt.aptoide.appsbackup.data.webservices.ViewDownloadStatus;
import pt.aptoide.appsbackup.data.webservices.ViewIconDownloadPermissions;
import pt.aptoide.appsbackup.data.webservices.ViewListAppsDownload;
...
import pt.aptoide.appsbackup.data.xml.EnumInfoType;
import pt.aptoide.appsbackup.data.xml.ManagerXml;
import pt.aptoide.appsbackup.data.xml.ViewLatestVersionInfo;
import pt.aptoide.appsbackup.debug.AptoideLog;
import pt.aptoide.appsbackup.debug.InterfaceAptoideLog;
import pt.aptoide.appsbackup.debug.exceptions.AptoideExceptionConnectivity;
import pt.aptoide.appsbackup.debug.exceptions.AptoideExceptionDatabase;
import pt.aptoide.appsbackup.debug.exceptions.AptoideExceptionDownload;
import pt.aptoide.appsbackup.debug.exceptions.AptoideExceptionSpaceInSDCard;
