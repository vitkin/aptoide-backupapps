...
package pt.aptoide.appsbackup.data.notifications;
...
import pt.aptoide.appsbackup.Notifier;
...
//		}
		...
		onClick.setClassName("pt.aptoide.appsbackup", "pt.aptoide.appsbackup.Aptoide");
		onClick.setFlags(Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT | Intent.FLAG_ACTIVITY_NEW_TASK);
		onClick.setAction("pt.aptoide.appsbackup.FROM_NOTIFICATION");
...
//		
//		Intent onClick = new Intent("pt.aptoide.INSTALL_APK", Uri.parse("apk:"+packageName));
...
//-------------------
	...
	private Notification getNotification() {
        ...
        notification.setLatestEventInfo(serviceData.getApplicationContext(), serviceData.getText(R.string.self_name), serviceData.getManagerSystemSync().getAptoideVersionNameInUse(), contentIntent);
