 ...
 *
 */
public class ParserRepoDownload extends DefaultHandler{
	...
	public ParserRepoDownload(ManagerXml managerXml, ViewXmlParse parseInfo){
		this.managerXml = managerXml;
		this.parseInfo = parseInfo;
	}	
	public ParserRepoDownload(ManagerXml managerXml, ViewXmlParse parseInfo, int appHashid){
