...
*/
package pt.aptoide.backupapps.data;
...
import pt.aptoide.backupapps.Aptoide;
import pt.aptoide.backupapps.BazaarLogin;
import pt.aptoide.backupapps.EnumAppsSorting;
import pt.aptoide.backupapps.ManageRepos;
import pt.aptoide.backupapps.R;
import pt.aptoide.backupapps.SelfUpdate;
import pt.aptoide.backupapps.Splash;
import pt.aptoide.backupapps.Upload;
...
import pt.aptoide.backupapps.data.display.ViewDisplayAppVersionExtras;
import pt.aptoide.backupapps.data.display.ViewDisplayAppVersionStats;
import pt.aptoide.backupapps.data.display.ViewDisplayAppVersionsInfo;
...
import pt.aptoide.backupapps.data.display.ViewDisplayListComments;
...
import pt.aptoide.backupapps.data.model.ViewApplication;
import pt.aptoide.backupapps.data.model.ViewApplicationInstalled;
import pt.aptoide.backupapps.data.model.ViewIconInfo;
...
import pt.aptoide.backupapps.data.notifications.ManagerNotifications;
import pt.aptoide.backupapps.data.preferences.EnumAgeRating;
import pt.aptoide.backupapps.data.preferences.ManagerPreferences;
import pt.aptoide.backupapps.data.preferences.ViewSettings;
import pt.aptoide.backupapps.data.system.ManagerSystemSync;
import pt.aptoide.backupapps.data.system.ViewHwFilters;
import pt.aptoide.backupapps.data.system.ViewScreenDimensions;
import pt.aptoide.backupapps.data.util.Constants;
import pt.aptoide.backupapps.data.webservices.EnumDownloadType;
...
import pt.aptoide.backupapps.data.webservices.ManagerDownloads;
import pt.aptoide.backupapps.data.webservices.ManagerUploads;
import pt.aptoide.backupapps.data.webservices.ViewApk;
import pt.aptoide.backupapps.data.webservices.ViewDownload;
import pt.aptoide.backupapps.data.webservices.ViewDownloadInfo;
import pt.aptoide.backupapps.data.webservices.ViewDownloadStatus;
import pt.aptoide.backupapps.data.webservices.ViewIconDownloadPermissions;
import pt.aptoide.backupapps.data.webservices.ViewListAppsDownload;
...
import pt.aptoide.backupapps.data.xml.ManagerXml;
import pt.aptoide.backupapps.data.xml.ViewLatestVersionInfo;
import pt.aptoide.backupapps.debug.AptoideLog;
import pt.aptoide.backupapps.debug.InterfaceAptoideLog;
import pt.aptoide.backupapps.debug.exceptions.AptoideExceptionConnectivity;
import pt.aptoide.backupapps.debug.exceptions.AptoideExceptionDatabase;
import pt.aptoide.backupapps.debug.exceptions.AptoideExceptionDownload;
import pt.aptoide.backupapps.debug.exceptions.AptoideExceptionSpaceInSDCard;
...
import pt.aptoide.backupapps.AIDLAppInfo;
import pt.aptoide.backupapps.AIDLAptoideInterface;
import pt.aptoide.backupapps.AIDLReposInfo;
import pt.aptoide.backupapps.AIDLSelfUpdate;
